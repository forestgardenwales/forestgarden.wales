...
What I do find strange though is that, despite the vast and detailed amount of work that has obviously gone in to [Joy of Plants](https://joyofplants.com/), it’s not that widely publicised in the ”gardening social circles” which I’ve started researching. My guess is that the work is one thing, the networking another – all the more reason to join in with groups like [Garden Bloggers](https://www.facebook.com/GardenBloggers) to help spread the word of good work.
